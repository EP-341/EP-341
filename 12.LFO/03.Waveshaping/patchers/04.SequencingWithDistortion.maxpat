...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 949.166666666666515, 659.0, 61.0, 22.0 ],
					"text" : "r quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 868.5, 659.0, 65.0, 22.0 ],
					"text" : "r decimate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 788.5, 690.0, 179.0, 22.0 ],
					"text" : "degrade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.166666666666515, 659.0, 61.0, 22.0 ],
					"text" : "r quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.5, 659.0, 65.0, 22.0 ],
					"text" : "r decimate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1226.5, 220.0, 81.0, 22.0 ],
					"text" : "snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 954.5, 220.0, 81.0, 22.0 ],
					"text" : "snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 546.5, 690.0, 179.0, 22.0 ],
					"text" : "degrade~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1226.5, 256.0, 63.0, 22.0 ],
					"text" : "s quantize"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 546.5, 737.0, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 954.5, 256.0, 67.0, 22.0 ],
					"text" : "s decimate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 44.0, 531.0, 47.0 ],
					"text" : "● This example uses LFOs to control the decimation and quantization parameter of [degrade~]."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Sequencing with Distortion"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 546.5, 797.0, 48.25, 48.25 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 798.0, 724.0, 673.0, 724.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-69::obj-22" : [ "Phase[1]", "Phase", 0 ],
			"obj-69::obj-25" : [ "live.numbox[7]", "live.numbox", 0 ],
			"obj-69::obj-26" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-69::obj-27" : [ "live.tab[1]", "live.tab", 0 ],
			"obj-69::obj-37" : [ "live.button[4]", "live.button", 0 ],
